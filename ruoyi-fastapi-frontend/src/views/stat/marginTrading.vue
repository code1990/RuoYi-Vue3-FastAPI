...
import { getMarginLongStatistics } from '@/api/stock/marginTrading'
...
async function getStatistics() { loading.value = true; try { renderChart((await getMarginLongStatistics({ targetReturnPct: 1.8 })).data) } finally { loading.value = false } }
